Matplotlib created a temporary config/cache directory at /var/lib/condor/execute/slot1/dir_95535/matplotlib-ar4xcpge because the default path (/.config/matplotlib) is not a writable directory; it is highly recommended to set the MPLCONFIGDIR environment variable to a writable directory, in particular to speed up the import of Matplotlib and to better support multiprocessing.
...
2021-08-31 17:07:02.504267: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcuda.so.1
2021-08-31 17:07:02.564491: I tensorflow/core/common_runtime/gpu/gpu_device.cc:1733] Found device 0 with properties: 
pciBusID: 0000:01:00.0 name: A100-SXM4-40GB computeCapability: 8.0
coreClock: 1.41GHz coreCount: 108 deviceMemorySize: 39.59GiB deviceMemoryBandwidth: 1.41TiB/s
2021-08-31 17:07:02.564557: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcudart.so.11.0
2021-08-31 17:07:02.567688: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcublas.so.11
2021-08-31 17:07:02.567746: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcublasLt.so.11
2021-08-31 17:07:02.568821: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcufft.so.10
2021-08-31 17:07:02.569095: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcurand.so.10
2021-08-31 17:07:02.569887: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcusolver.so.11
2021-08-31 17:07:02.570554: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcusparse.so.11
2021-08-31 17:07:02.570786: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcudnn.so.8
2021-08-31 17:07:02.574931: I tensorflow/core/common_runtime/gpu/gpu_device.cc:1871] Adding visible gpu devices: 0
2021-08-31 17:07:02.574973: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcudart.so.11.0
2021-08-31 17:07:02.935898: I tensorflow/core/common_runtime/gpu/gpu_device.cc:1258] Device interconnect StreamExecutor with strength 1 edge matrix:
2021-08-31 17:07:02.935957: I tensorflow/core/common_runtime/gpu/gpu_device.cc:1264]      0 
2021-08-31 17:07:02.935966: I tensorflow/core/common_runtime/gpu/gpu_device.cc:1277] 0:   N 
2021-08-31 17:07:02.940966: I tensorflow/core/common_runtime/gpu/gpu_device.cc:1418] Created TensorFlow device (/job:localhost/replica:0/task:0/device:GPU:0 with 38423 MB memory) -> physical GPU (device: 0, name: A100-SXM4-40GB, pci bus id: 0000:01:00.0, compute capability: 8.0)
...
__________________________________________________________________________________________________
Compound (Dense)                (None, 1018)         1304058     pool5[0][0]                      
==================================================================================================
Total params: 5,354,209
Trainable params: 5,312,182
Non-trainable params: 42,027
__________________________________________________________________________________________________
2021-08-31 17:07:03,153 - WARNING - From /DeepProfiler/deepprofiler/learning/model.py:133: The name tf.keras.backend.set_session is deprecated. Please use tf.compat.v1.keras.backend.set_session instead.

2021-08-31 17:07:03.654706: I tensorflow/core/platform/profile_utils/cpu_utils.cc:114] CPU Frequency: 3200140000 Hz
Validation data loaded : 2069 records of 2069
Downloading data from https://storage.googleapis.com/keras-applications/efficientnetb0_notop.h5
16711680/16705208 [==============================] - 0s 0us/step
Network initialized with pretrained ImageNet weights
2021-08-31 17:12:07,317 - WARNING - `period` argument is deprecated. Please use `save_freq` to specify the frequency in number of batches seen.
2021-08-31 17:12:20.771754: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcudnn.so.8
2021-08-31 17:12:21.296377: I tensorflow/stream_executor/cuda/cuda_dnn.cc:359] Loaded cuDNN version 8100
2021-08-31 17:12:21.918560: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcublas.so.11
2021-08-31 17:12:22.448585: I tensorflow/stream_executor/platform/default/dso_loader.cc:53] Successfully opened dynamic library libcublasLt.so.11
2021-08-31 17:12:22.839453: I tensorflow/stream_executor/cuda/cuda_blas.cc:1838] TensorFloat-32 will be used for the matrix multiplication. This will only be logged once.
 || => Total single cells: 10544180
 || => Median # of images per class: 27
 || => Number of classes: 1018
 || => Median # of cells per image: 243
 || => Approx. cells per epoch (with balanced sampling): 6679098
 || => Images sampled per worker: 32
 || => Cache data coverage: 0%
 || => Steps per epoch: 52180

Epoch 00001: LearningRateScheduler reducing learning rate to 0.001.
Epoch 1/20
52180/52180 [==============================] - 15921s 305ms/step - batch: 26089.5000 - size: 128.0000 - loss: 4.4376 - acc: 0.1734 - top_5: 0.3740 - val_loss: nan - val_acc: 0.0439 - val_top_5: 0.1248 - lr: 0.0010

Epoch 00002: LearningRateScheduler reducing learning rate to 0.00125.
Epoch 2/20
52180/52180 [==============================] - 15823s 303ms/step - batch: 26089.5000 - size: 128.0000 - loss: 2.3094 - acc: 0.4550 - top_5: 0.7603 - val_loss: nan - val_acc: 0.0258 - val_top_5: 0.0696 - lr: 0.0012

Epoch 00003: LearningRateScheduler reducing learning rate to 0.0016666666666666668.
Epoch 3/20
52180/52180 [==============================] - 14945s 286ms/step - batch: 26089.5000 - size: 128.0000 - loss: 1.7389 - acc: 0.5817 - top_5: 0.8615 - val_loss: nan - val_acc: 0.1992 - val_top_5: 0.4122 - lr: 0.0017

Epoch 00004: LearningRateScheduler reducing learning rate to 0.0025.
Epoch 4/20
52180/52180 [==============================] - 15694s 301ms/step - batch: 26089.5000 - size: 128.0000 - loss: 1.4164 - acc: 0.6608 - top_5: 0.9099 - val_loss: nan - val_acc: 0.2007 - val_top_5: 0.4119 - lr: 0.0025

Epoch 00005: LearningRateScheduler reducing learning rate to 0.005.
Epoch 5/20
52180/52180 [==============================] - 16885s 324ms/step - batch: 26089.5000 - size: 128.0000 - loss: 1.2076 - acc: 0.7143 - top_5: 0.9373 - val_loss: nan - val_acc: 0.2237 - val_top_5: 0.4478 - lr: 0.0050

Epoch 00006: LearningRateScheduler reducing learning rate to 0.004267766952966369.
Epoch 6/20
52180/52180 [==============================] - 16391s 314ms/step - batch: 26089.5000 - size: 128.0000 - loss: 0.9347 - acc: 0.7910 - top_5: 0.9666 - val_loss: nan - val_acc: 0.2074 - val_top_5: 0.4175 - lr: 0.0043

Epoch 00007: LearningRateScheduler reducing learning rate to 0.003969463130731183.
Epoch 7/20
52180/52180 [==============================] - 16096s 308ms/step - batch: 26089.5000 - size: 128.0000 - loss: 0.7791 - acc: 0.8365 - top_5: 0.9796 - val_loss: nan - val_acc: 0.2350 - val_top_5: 0.4560 - lr: 0.0040

Epoch 00008: LearningRateScheduler reducing learning rate to 0.003634976249348867.
Epoch 8/20
52180/52180 [==============================] - 17107s 328ms/step - batch: 26089.5000 - size: 128.0000 - loss: 0.6677 - acc: 0.8694 - top_5: 0.9872 - val_loss: nan - val_acc: 0.2368 - val_top_5: 0.4608 - lr: 0.0036

Epoch 00009: LearningRateScheduler reducing learning rate to 0.0032725424859373687.
Epoch 9/20
52180/52180 [==============================] - 19048s 365ms/step - batch: 26089.5000 - size: 128.0000 - loss: 0.5831 - acc: 0.8948 - top_5: 0.9920 - val_loss: nan - val_acc: 0.2390 - val_top_5: 0.4658 - lr: 0.0033

Epoch 00010: LearningRateScheduler reducing learning rate to 0.0028910861626005773.
Epoch 10/20
52180/52180 [==============================] - 18949s 363ms/step - batch: 26089.5000 - size: 128.0000 - loss: 0.5127 - acc: 0.9162 - top_5: 0.9951 - val_loss: nan - val_acc: 0.2452 - val_top_5: 0.4654 - lr: 0.0029

Epoch 00011: LearningRateScheduler reducing learning rate to 0.0025.
Epoch 11/20
52180/52180 [==============================] - 19133s 367ms/step - batch: 26089.5000 - size: 128.0000 - loss: 0.4575 - acc: 0.9333 - top_5: 0.9970 - val_loss: nan - val_acc: 0.2633 - val_top_5: 0.4881 - lr: 0.0025

Epoch 00012: LearningRateScheduler reducing learning rate to 0.0021089138373994237.
Epoch 12/20
52180/52180 [==============================] - 21117s 405ms/step - batch: 26089.5000 - size: 128.0000 - loss: 0.4133 - acc: 0.9469 - top_5: 0.9982 - val_loss: nan - val_acc: 0.2603 - val_top_5: 0.4790 - lr: 0.0021

Epoch 00013: LearningRateScheduler reducing learning rate to 0.0017274575140626316.
Epoch 13/20
52180/52180 [==============================] - 18063s 346ms/step - batch: 26089.5000 - size: 128.0000 - loss: 0.3767 - acc: 0.9581 - top_5: 0.9988 - val_loss: nan - val_acc: 0.2510 - val_top_5: 0.4778 - lr: 0.0017

Epoch 00014: LearningRateScheduler reducing learning rate to 0.0013650237506511332.
Epoch 14/20
52180/52180 [==============================] - 16640s 319ms/step - batch: 26089.5000 - size: 128.0000 - loss: 0.3491 - acc: 0.9665 - top_5: 0.9992 - val_loss: nan - val_acc: 0.2699 - val_top_5: 0.4982 - lr: 0.0014

Epoch 00015: LearningRateScheduler reducing learning rate to 0.0010305368692688174.
Epoch 15/20
52180/52180 [==============================] - 16760s 321ms/step - batch: 26089.5000 - size: 128.0000 - loss: 0.3280 - acc: 0.9727 - top_5: 0.9995 - val_loss: nan - val_acc: 0.2649 - val_top_5: 0.4870 - lr: 0.0010
